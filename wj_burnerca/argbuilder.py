...
class _GroupedCommandsHelpFormatter(_FixedHelpFormatter):
    ...
    def _format_actions_usage(
        ...
        # `_format_actions_usage` exists at runtime on argparse.HelpFormatter but isn't
        # exposed by typeshed (it's private). Cast through Any to silence strict pyright.
        return cast("str", cast("Any", super())._format_actions_usage(actions, groups))
